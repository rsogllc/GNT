...
![The Parts Of A Transaction](/devdocs/img/dev/en-tx-overview.svg)
...
![Spending An Output](/devdocs/img/dev/en-tx-overview-spending.svg)
...
![Creating A P2PKH Public Key Hash To Receive Payment](/devdocs/img/dev/en-creating-p2pkh-output.svg)
...
![Unlocking A P2PKH Output For Spending](/devdocs/img/dev/en-unlocking-p2pkh-output.svg)
...
![Some Things Signed When Spending An Output](/devdocs/img/dev/en-signing-output-to-spend.svg)
...
![P2PKH Stack Evaluation](/devdocs/img/dev/en-p2pkh-stack.svg)
...
![Creating A P2SH Redeem Script And Hash](/devdocs/img/dev/en-creating-p2sh-output.svg)
...
![Unlocking A P2SH Output For Spending](/devdocs/img/dev/en-unlocking-p2sh-output.svg)
