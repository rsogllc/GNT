...
![Block Chain Overview](/devdocs/img/dev/en-blockchain-overview.svg)
...
![Transaction Propagation](/devdocs/img/dev/en-transaction-propagation.svg)
...
![Common And Uncommon Block Chain Forks](/devdocs/img/dev/en-blockchain-fork.svg)
...
![Hard Fork](/devdocs/img/dev/en-hard-fork.svg)
...
![Soft Fork](/devdocs/img/dev/en-soft-fork.svg)
