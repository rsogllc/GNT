...
![Bitcoin Payment Processing](/devdocs/img/dev/en-payment-processing.svg)
...
![Bitcoin QR Codes](/devdocs/img/dev/en-qr-code.svg)
...
![BIP70 Payment Protocol](/devdocs/img/dev/en-payment-protocol.svg)
...
![Bitcoin Core Showing Validated Payment Request](/devdocs/img/dev/en-btcc-payment-request.png)
