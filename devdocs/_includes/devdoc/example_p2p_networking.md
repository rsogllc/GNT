...
![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-001.svg)

We start by building the structure of a merkle tree based on the number
of transactions in the block.

![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-002.svg)
...
![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-003.svg)
...
![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-004.svg)

The third flag in the example is another 1 on another non-TXID node, so
we descend into its left child.

![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-005.svg)
...
![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-006.svg)
...
![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-007.svg)
...
![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-008.svg)
...
![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-009.svg)
...
![Parsing A MerkleBlock](/devdocs/img/dev/gifs/en-merkleblock-parsing/en-merkleblock-parsing-011.svg)
