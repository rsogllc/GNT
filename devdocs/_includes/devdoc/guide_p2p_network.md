...
![Overview Of Blocks-First Method](/devdocs/img/dev/en-blocks-first-flowchart.svg)
...
![First GetBlocks Message Sent During IBD](/devdocs/img/dev/en-ibd-getblocks.svg)
...
![First Inv Message Sent During IBD](/devdocs/img/dev/en-ibd-inv.svg)
...
![First GetData Message Sent During IBD](/devdocs/img/dev/en-ibd-getdata.svg)
...
![First Block Message Sent During IBD](/devdocs/img/dev/en-ibd-block.svg)
...
![Second GetBlocks Message Sent During IBD](/devdocs/img/dev/en-ibd-getblocks2.svg)
...
![Overview Of Headers-First Method](/devdocs/img/dev/en-headers-first-flowchart.svg)
...
![First getheaders message](/devdocs/img/dev/en-ibd-getheaders.svg)
...
![First headers message](/devdocs/img/dev/en-ibd-headers.svg)
...
![Simulated Headers-First Download Window](/devdocs/img/dev/en-headers-first-moving-window.svg)
...
![Difference Between Orphan And Stale Blocks](/devdocs/img/dev/en-orphan-stale-definition.svg)
